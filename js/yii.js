...
$('.product .product__quantity_btn').on('click', function () {
    yaCounter32073876.reachGoal('onsubmit_otpravka');
});
$('.product-one__info .product__quantity_btn').on('click', function () {
    yaCounter32073876.reachGoal('onsubmit_otpravka1');
});


$('.header__basket a').on('click', function () {
    yaCounter32073876.reachGoal('onclick_klicforma');
});

$('#form-order .float-right .btn').on('click', function () {
    yaCounter32073876.reachGoal('onsubmit_otpravkaforma');
});
